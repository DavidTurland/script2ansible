...
class Processor:
    ...
    def process(self):
        raise NotImplementedError("Subclasses should implement this method to return tasks.")   
    ...
    def process(self):
        ...
        for file_name in (glob.glob(f"{files_dir}/**/*", recursive=True)):
            if (os.path.isfile(file_name)):
                ...
                build_dest_path = os.path.join(self.ansible_role_dir, 'files', relative_path)
